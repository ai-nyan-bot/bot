...
create table jupiter.candle_usd_1s
(
...
create table jupiter.candle_usd_1s_1 partition of jupiter.candle_usd_1s for values with (modulus 8, remainder 0);

create table jupiter.candle_usd_1s_2 partition of jupiter.candle_usd_1s for values with (modulus 8, remainder 1);

create table jupiter.candle_usd_1s_3 partition of jupiter.candle_usd_1s for values with (modulus 8, remainder 2);

create table jupiter.candle_usd_1s_4 partition of jupiter.candle_usd_1s for values with (modulus 8, remainder 3);

create table jupiter.candle_usd_1s_5 partition of jupiter.candle_usd_1s for values with (modulus 8, remainder 4);

create table jupiter.candle_usd_1s_6 partition of jupiter.candle_usd_1s for values with (modulus 8, remainder 5);

create table jupiter.candle_usd_1s_7 partition of jupiter.candle_usd_1s for values with (modulus 8, remainder 6);

create table jupiter.candle_usd_1s_8 partition of jupiter.candle_usd_1s for values with (modulus 8, remainder 7);

create index candle_usd_1s_timestamp ON jupiter.candle_usd_1s (timestamp desc);

create table jupiter.candle_usd_1s_most_recent
(
    token_pair_id int4             not null,
    timestamp     timestamptz      not null,
    open          numeric(36, 12) not null,
...
create
or replace function jupiter.candle_usd_1s_update_most_recent() returns trigger as $$
begin
delete
from jupiter.candle_usd_1s_most_recent
where token_pair_id = new.token_pair_id;

insert into jupiter.candle_usd_1s_most_recent
values (new.*);
return new;
end;
$$
...
create trigger update_most_recent_candle
    after insert
    on jupiter.candle_usd_1s
    for each row execute function jupiter.candle_usd_1s_update_most_recent();
...
create table jupiter.candle_usd_1m_most_recent
(
    token_pair_id int4             not null,
    timestamp     timestamptz      not null,
    open          numeric(36, 12) not null,
...
create
or replace function jupiter.candle_usd_1m_update_most_recent() returns trigger as $$
begin
delete
from jupiter.candle_usd_1m_most_recent
where token_pair_id = new.token_pair_id;

insert into jupiter.candle_usd_1m_most_recent
values (new.*);
return new;
end;
$$
...
create trigger update_most_recent_candle
    after insert
    on jupiter.candle_usd_1m
    for each row execute function jupiter.candle_usd_1m_update_most_recent();
...
create table jupiter.candle_usd_5m_most_recent
(
    token_pair_id int4             not null,
    timestamp     timestamptz      not null,
    open          numeric(36, 12) not null,
...
create
or replace function jupiter.candle_usd_5m_update_most_recent() returns trigger as $$
begin
delete
from jupiter.candle_usd_5m_most_recent
where token_pair_id = new.token_pair_id;

insert into jupiter.candle_usd_5m_most_recent
values (new.*);
return new;
end;
$$
...
create trigger update_most_recent_candle
    after insert
    on jupiter.candle_usd_5m
    for each row execute function jupiter.candle_usd_5m_update_most_recent();
...
create table jupiter.candle_usd_15m_most_recent
(
    token_pair_id int4             not null,
    timestamp     timestamptz      not null,
    open          numeric(36, 12) not null,
...
create
or replace function jupiter.candle_usd_15m_update_most_recent() returns trigger as $$
begin
delete
from jupiter.candle_usd_15m_most_recent
where token_pair_id = new.token_pair_id;

insert into jupiter.candle_usd_15m_most_recent
values (new.*);
return new;
end;
$$
...
create trigger update_most_recent_candle
    after insert
    on jupiter.candle_usd_15m
    for each row execute function jupiter.candle_usd_15m_update_most_recent();
...
create table jupiter.candle_usd_1h_most_recent
(
    token_pair_id int4             not null,
    timestamp     timestamptz      not null,
    open          numeric(36, 12) not null,
...
create
or replace function jupiter.candle_usd_1h_update_most_recent() returns trigger as $$
begin
delete
from jupiter.candle_usd_1h_most_recent
where token_pair_id = new.token_pair_id;

insert into jupiter.candle_usd_1h_most_recent
values (new.*);
return new;
end;
$$
...
create trigger update_most_recent_candle
    after insert
    on jupiter.candle_usd_1h
    for each row execute function jupiter.candle_usd_1h_update_most_recent();
...
create table jupiter.candle_usd_6h_most_recent
(
    token_pair_id int4             not null,
    timestamp     timestamptz      not null,
    open          numeric(36, 12) not null,
...
create
or replace function jupiter.candle_usd_6h_update_most_recent() returns trigger as $$
begin
delete
from jupiter.candle_usd_6h_most_recent
where token_pair_id = new.token_pair_id;

insert into jupiter.candle_usd_6h_most_recent
values (new.*);
return new;
end;
$$
...
create trigger update_most_recent_candle
    after insert
    on jupiter.candle_usd_6h
    for each row execute function jupiter.candle_usd_6h_update_most_recent();
...
create table jupiter.candle_usd_1d_most_recent
(
    token_pair_id int4             not null,
    timestamp     timestamptz      not null,
    open          numeric(36, 12) not null,
...
create
or replace function jupiter.candle_usd_1d_update_most_recent() returns trigger as $$
begin
delete
from jupiter.candle_usd_1d_most_recent
where token_pair_id = new.token_pair_id;

insert into jupiter.candle_usd_1d_most_recent
values (new.*);
return new;
end;
$$
...
create trigger update_most_recent_candle
    after insert
    on jupiter.candle_usd_1d
    for each row execute function jupiter.candle_usd_1d_update_most_recent();