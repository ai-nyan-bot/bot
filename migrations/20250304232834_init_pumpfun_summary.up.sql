...
(
    ...
    holder_open                 int4,
    holder_open_change          numeric(36, 12),
    holder_open_percent         real,

    holder_high                 int4,
    holder_high_change          numeric(36, 12),
    holder_high_percent         real,

    holder_low                  int4,
    holder_low_change           numeric(36, 12),
    holder_low_percent          real,

    holder_close                int4,
    holder_close_change         numeric(36, 12),
    holder_close_percent        real,

    holder_avg                  int4,
    holder_avg_change           numeric(36, 12),
