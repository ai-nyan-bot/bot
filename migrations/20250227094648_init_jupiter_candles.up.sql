...
create index candle_1s_1_timestamp ON jupiter.candle_1s_1 (timestamp desc);
create index candle_1s_2_timestamp ON jupiter.candle_1s_2 (timestamp desc);
create index candle_1s_3_timestamp ON jupiter.candle_1s_3 (timestamp desc);
create index candle_1s_4_timestamp ON jupiter.candle_1s_4 (timestamp desc);
create index candle_1s_5_timestamp ON jupiter.candle_1s_5 (timestamp desc);
create index candle_1s_6_timestamp ON jupiter.candle_1s_6 (timestamp desc);
create index candle_1s_7_timestamp ON jupiter.candle_1s_7 (timestamp desc);
create index candle_1s_8_timestamp ON jupiter.candle_1s_8 (timestamp desc);
...
create index candle_1m_1_timestamp ON jupiter.candle_1m_1 (timestamp desc);
create index candle_1m_2_timestamp ON jupiter.candle_1m_2 (timestamp desc);
create index candle_1m_3_timestamp ON jupiter.candle_1m_3 (timestamp desc);
create index candle_1m_4_timestamp ON jupiter.candle_1m_4 (timestamp desc);
create index candle_1m_5_timestamp ON jupiter.candle_1m_5 (timestamp desc);
create index candle_1m_6_timestamp ON jupiter.candle_1m_6 (timestamp desc);
create index candle_1m_7_timestamp ON jupiter.candle_1m_7 (timestamp desc);
create index candle_1m_8_timestamp ON jupiter.candle_1m_8 (timestamp desc);
...
create index candle_5m_1_timestamp ON jupiter.candle_5m_1 (timestamp desc);
create index candle_5m_2_timestamp ON jupiter.candle_5m_2 (timestamp desc);
create index candle_5m_3_timestamp ON jupiter.candle_5m_3 (timestamp desc);
create index candle_5m_4_timestamp ON jupiter.candle_5m_4 (timestamp desc);
create index candle_5m_5_timestamp ON jupiter.candle_5m_5 (timestamp desc);
create index candle_5m_6_timestamp ON jupiter.candle_5m_6 (timestamp desc);
create index candle_5m_7_timestamp ON jupiter.candle_5m_7 (timestamp desc);
create index candle_5m_8_timestamp ON jupiter.candle_5m_8 (timestamp desc);
...
create index candle_15m_1_timestamp ON jupiter.candle_15m_1 (timestamp desc);
create index candle_15m_2_timestamp ON jupiter.candle_15m_2 (timestamp desc);
create index candle_15m_3_timestamp ON jupiter.candle_15m_3 (timestamp desc);
create index candle_15m_4_timestamp ON jupiter.candle_15m_4 (timestamp desc);
create index candle_15m_5_timestamp ON jupiter.candle_15m_5 (timestamp desc);
create index candle_15m_6_timestamp ON jupiter.candle_15m_6 (timestamp desc);
create index candle_15m_7_timestamp ON jupiter.candle_15m_7 (timestamp desc);
create index candle_15m_8_timestamp ON jupiter.candle_15m_8 (timestamp desc);
...
create index candle_1h_1_timestamp ON jupiter.candle_1h_1 (timestamp desc);
create index candle_1h_2_timestamp ON jupiter.candle_1h_2 (timestamp desc);
create index candle_1h_3_timestamp ON jupiter.candle_1h_3 (timestamp desc);
create index candle_1h_4_timestamp ON jupiter.candle_1h_4 (timestamp desc);
create index candle_1h_5_timestamp ON jupiter.candle_1h_5 (timestamp desc);
create index candle_1h_6_timestamp ON jupiter.candle_1h_6 (timestamp desc);
create index candle_1h_7_timestamp ON jupiter.candle_1h_7 (timestamp desc);
create index candle_1h_8_timestamp ON jupiter.candle_1h_8 (timestamp desc);
...
create index candle_6h_1_timestamp ON jupiter.candle_6h_1 (timestamp desc);
create index candle_6h_2_timestamp ON jupiter.candle_6h_2 (timestamp desc);
create index candle_6h_3_timestamp ON jupiter.candle_6h_3 (timestamp desc);
create index candle_6h_4_timestamp ON jupiter.candle_6h_4 (timestamp desc);
create index candle_6h_5_timestamp ON jupiter.candle_6h_5 (timestamp desc);
create index candle_6h_6_timestamp ON jupiter.candle_6h_6 (timestamp desc);
create index candle_6h_7_timestamp ON jupiter.candle_6h_7 (timestamp desc);
create index candle_6h_8_timestamp ON jupiter.candle_6h_8 (timestamp desc);
...
create index candle_1d_1_timestamp ON jupiter.candle_1d_1 (timestamp desc);
create index candle_1d_2_timestamp ON jupiter.candle_1d_2 (timestamp desc);
create index candle_1d_3_timestamp ON jupiter.candle_1d_3 (timestamp desc);
create index candle_1d_4_timestamp ON jupiter.candle_1d_4 (timestamp desc);
create index candle_1d_5_timestamp ON jupiter.candle_1d_5 (timestamp desc);
create index candle_1d_6_timestamp ON jupiter.candle_1d_6 (timestamp desc);
create index candle_1d_7_timestamp ON jupiter.candle_1d_7 (timestamp desc);
create index candle_1d_8_timestamp ON jupiter.candle_1d_8 (timestamp desc);
