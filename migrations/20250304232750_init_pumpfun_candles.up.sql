...
(
    ...
    amount_base_buy   double precision not null,
    amount_quote_buy  double precision not null,
    amount_base_sell  double precision not null,
    amount_quote_sell double precision not null,
...
create index candle_6h_timestamp ON pumpfun.candle_6h (timestamp desc);
