        ...
        for partition in Partition::enumerate() {
            ...
            result.push(tokio::spawn(async move {
                loop {
                    ...
                    repo.calculate_progress_1m(&mut tx, partition).await.unwrap();
                    ...
                    repo.calculate_progress_5m(&mut tx, partition).await.unwrap();
                    ...
                    repo.calculate_progress_15m(&mut tx, partition).await.unwrap();
                    ...
                    repo.calculate_progress_1h(&mut tx, partition).await.unwrap();
                    ...
                    repo.calculate_progress_6h(&mut tx, partition).await.unwrap();
                    ...
                    repo.calculate_progress_1d(&mut tx, partition).await.unwrap();
