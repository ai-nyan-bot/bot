...
mod tests {
    ...
    fn read_f64() {
        let cases = [
            ...
            // Little-endian bytes for -1.0f64
            (
                vec![0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0xBF],
                -1.0f64,
            ),
            ...
            // Little-endian bytes for -2.5f64
            (
                vec![0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0xC0],
                -2.5f64,
            ),
        ];
    ...
    fn read_range() {
        ...
        assert_eq!(
            test_instance.read_range(4).unwrap(),
            [0x01, 0x02, 0x03, 0x04]
        );
        assert_eq!(test_instance.read_u8().unwrap(), 0x05);
    ...
    mod read_variable_length {
        ...
        fn test_u64() {
            let data: &[u8] = &[
                0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, b'a', b'b', b'c', b'd', b'e', b'f',
            ];
            let test_instance = ByteReader::new(data);
