...
use crate::model::{
    NotificationChannel, NotificationPayload, NotificationType, RuleId, UserId, Venue,
};
...
impl NotificationService {
    pub async fn create_rule_matched(
        &self,
        notification: NotificationRuleMatched,
    ) -> ServiceResult<()> {
    ...
    pub async fn create_rule_matched_tx<'a>(
        &self,
        tx: &mut Tx<'a>,
        notification: NotificationRuleMatched,
    ) -> ServiceResult<()> {
                    ...
                    .create(
                        ...
                        NotificationCreateCmd {
                            ...
                            payload: NotificationPayload(JsonValue::Object({
                                ...
                                map.insert("venue".to_string(), serde_json::to_value(venue)?);
                                map.insert(
                                    "button_0".to_string(),
                                    serde_json::to_value(
                                        buttons
