...
mod tests {
    ...
    fn test_set_and_get_fact_with_timeframe() {
        let mut test_instance = Facts::new();
        let fact = Fact::SwapsBuyChangePercent;
    ...
    fn test_exists_fact_with_timeframe() {
        let mut test_instance = Facts::new();
        let fact = Fact::SwapsChangePercent;
        let timeframe = Timeframe::D1;
    ...
    fn test_get_nonexistent_fact() {
        ...
        assert!(test_instance.get(&Fact::SwapsBuyChangePercent).is_none());
        assert!(test_instance
            .get_with_timeframe(&Fact::SwapsBuyChangePercent, &Timeframe::W1)
            .is_none());
    }
