...
impl CandleRepo {
    pub async fn calculate_price_1s<'a>(
        ...
        let candle_price_table = format!("jupiter.candle_price_1s_{partition}");
...
previous_candles as (
    select r.* from jupiter.candle_price_1s_most_recent r
...
impl CandleRepo {
    pub async fn calculate_price_1m<'a>(
        ...
        aggregate_candle_price(
            ...
            1,
            "minute",
            format!("jupiter.candle_price_1s_{partition}").as_str(),
            format!("jupiter.candle_price_1m_{partition}").as_str(),
        )
        .await
    }
    ...
    pub async fn calculate_price_5m<'a>(
        ...
        aggregate_candle_price(
            ...
            "minute",
            format!("jupiter.candle_price_1m_{partition}").as_str(),
            format!("jupiter.candle_price_5m_{partition}").as_str(),
        )
        .await
    }
    ...
    pub async fn calculate_price_15m<'a>(
        ...
        aggregate_candle_price(
            ...
            "minute",
            format!("jupiter.candle_price_5m_{partition}").as_str(),
            format!("jupiter.candle_price_15m_{partition}").as_str(),
        )
        .await
    }
    ...
    pub async fn calculate_price_1h<'a>(
        ...
        aggregate_candle_price(
            ...
            "hour",
            format!("jupiter.candle_price_15m_{partition}").as_str(),
            format!("jupiter.candle_price_1h_{partition}").as_str(),
        )
        .await
    }
    ...
    pub async fn calculate_price_6h<'a>(
        ...
        aggregate_candle_price(
            ...
            "hours",
            format!("jupiter.candle_price_1h_{partition}").as_str(),
            format!("jupiter.candle_price_6h_{partition}").as_str(),
        )
        .await
    }
    pub async fn calculate_price_1d<'a>(
        ...
        aggregate_candle_price(
            ...
            "day",
            format!("jupiter.candle_price_6h_{partition}").as_str(),
            format!("jupiter.candle_price_1d_{partition}").as_str(),
        )
        .await
    }
}
