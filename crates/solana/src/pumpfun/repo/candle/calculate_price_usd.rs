...
impl CandleRepo {
    pub async fn calculate_price_usd_1m<'a>(
        ...
        calculate(
            ...
            1,
            "minute",
            format!("candle_price_1m_{}", partition),
    ...
    pub async fn calculate_price_usd_5m<'a>(
        ...
        calculate(
            ...
            5,
            "minute",
            format!("candle_price_5m_{}", partition),
    ...
    pub async fn calculate_price_usd_15m<'a>(
        ...
        calculate(
            ...
            15,
            "minute",
            format!("candle_price_15m_{}", partition),
    ...
    pub async fn calculate_price_usd_1h<'a>(
        ...
        calculate(
            ...
            1,
            "hour",
            format!("candle_price_1h_{}", partition),
    ...
    pub async fn calculate_price_usd_6h<'a>(
        ...
        calculate(
            ...
            6,
            "hours",
            format!("candle_price_6h_{}", partition),
    ...
    pub async fn calculate_price_usd_1d<'a>(
        ...
        calculate(
            ...
            1,
            "day",
            format!("candle_price_1d_{}", partition),
